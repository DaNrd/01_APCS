...
public class GameBoard extends JComponent {
    ...
    public int[][][] boardLayout = new int[boardWidth][boardHeight][3]; // array storing the pieces
    public int numRook = 2; // must be even
    public int numKnight = 2; // must be even
    public int numBishop = 2; // must be even
    public int scale; // for resizeable board
    ...
    public void possiblePawnMoves(int x, int y, int team) {
        if(team == 1) {
            ...
            if(existsBetween(y + 1, 8, 0)) {
                if(existsBetween(x - 1, 7, 0)) {
                    if(boardLayout[x - 1][y + 1][1] != 0) {
                        setTilePossible(x - 1, y + 1, team);
                    }
                }
                if(existsBetween(x + 1, 8, 0)) {
                    if(boardLayout[x + 1][y + 1][1] != 0) {
                        setTilePossible(x + 1, y + 1, team);
                    }
                }
    ...
    public void drawPawn(Graphics g, int i, int j) {
        g.fillOval((int)(scale * (i + 1.25)), (int)(scale * (j + 1.125)), (int)scale/2, (int)scale/2);
        g.fillPolygon(new int[] {(int)((i+1.2)*scale), (int)((i+1.5)*scale), (int)((i+1.8)*scale)}, new int[] {(int)((j+1.9)*scale), (int)(j+1.5)*scale, (int)((j+1.9)*scale)}, 3);
    }

    public void drawRook(Graphics g, int i, int j) {
        g.fillRect((int)(scale * (i + 1.25)), (int)(scale * (j + 1.125)), (int)(0.5*scale), (int)(0.75*scale));
    }

    public void drawKnight(Graphics g, int i, int j) {
        g.fillPolygon(new int[] {(int)((i+1.5)*scale), (int)((i+1.5)*scale), (int)((i+1.9)*scale)}, new int[] {(int)((j+1.1)*scale), (int)((j+1.5)*scale), (int)((j+1.2)*scale)}, 3);
        g.fillPolygon(new int[] {(int)((i+1.2)*scale), (int)((i+1.5)*scale), (int)((i+1.8)*scale)}, new int[] {(int)((j+1.9)*scale), (int)(j+1.5)*scale, (int)((j+1.9)*scale)}, 3);
    }

    public void drawBishop(Graphics g, int i, int j) {
        g.fillOval((int)(scale * (i + 1.25)), (int)(scale * (j + 1.125)), (int)scale/2, (int)scale/2);
        g.fillOval((int)(scale * (i + 1.25)), (int)(scale * (j + 1.5)), (int)scale/2, (int)scale/2);
    }

    public void drawKing(Graphics g, int i, int j) {
        g.fillPolygon(new int[] {(int)((i+1.2)*scale), (int)((i+1.1)*scale), (int)((i+1.5)*scale), (int)((i+1.9)*scale), (int)((i+1.8)*scale)}, new int[] {(int)((j+1.9)*scale), (int)((j+1.5)*scale), (int)((j+1.1)*scale), (int)((j+1.5)*scale), (int)((j+1.9)*scale)}, 5);
    }

    public void drawQueen(Graphics g, int i, int j) {
        g.fillPolygon(new int[] {(int)((i+1.2)*scale), (int)((i+1.2)*scale), (int)((i+1.4)*scale), (int)((i+1.5)*scale), (int)((i+1.6)*scale), (int)((i+1.8)*scale), (int)((i+1.8)*scale)}, new int[] {(int)((j+1.9)*scale), (int)((j+1.1)*scale), (int)((j+1.5)*scale), (int)((j+1.1)*scale), (int)((j+1.5)*scale), (int)((j+1.1)*scale), (int)((j+1.9)*scale)}, 7);
    }
}